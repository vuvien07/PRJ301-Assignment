 ...
 * @author Admin
 */
public class AdminAttendanceReportController extends BaseRBACController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response, Account account, ArrayList<Role> roles)
        ...
        ArrayList<Subject> subjects = sdc.listAll();
        GroupDBContext gdc = new GroupDBContext();
        if (subid != null) {
            ArrayList<Group> groups =gdc.listGroupBySubid(Integer.parseInt(subid));
...
//        }
        ...
        if (subid != null && gid != null && teid_raw != null) {
            ArrayList<Attendance> attendances = adc
                    .getAttendanceByGroup(lid, Integer.parseInt(subid), Integer.parseInt(teid_raw), Integer.parseInt(gid));
        ...
        request.getRequestDispatcher("view/admin/admin_attendance_report.jsp").forward(request, response);
    }
